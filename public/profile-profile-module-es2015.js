...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProfilePgComponent", function() { return ProfilePgComponent; });
...
/* harmony import */ var _shared_filter_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../shared/filter.service */ "./src/app/shared/filter.service.ts");
...
;
;
let ProfilePgComponent = class ProfilePgComponent {
    constructor(modalService, formBuilder, fetch, filterSrv, authService) {
    ...
    getProfile() {
        this.fetch.getProfInfo().subscribe(res => {
            this.profile = res;
    ...
    updateInfo() {
        ...
        if (this.infoFrm.invalid) {
            ...
            this.fetch.modUsr(formObj).subscribe(res => {
                this.infoFrm.reset();
                this.regBtn = false;
    ...
    updatePass() {
        ...
        if (this.passFrm.invalid || this.pssFrm.newPass.value !== this.pssFrm.confPass.value) {
            ...
            this.fetch.modPass(formObj).subscribe(res => {
                this.passFrm.reset();
                this.psBtn = false;
    ...
    addSponsor() {
        ...
        if (this.sponsorFrm.invalid) {
            ...
            this.fetch.addPayee(formObj).subscribe(res => {
    ...
    getSponsor() {
        this.fetch.getSponsor().subscribe(res => { this.listSponsor = res; }, err => { this.psMsg = { msg: err.error, alert: 'alert-danger' }; });
        setTimeout(() => {
            this.psMsg = null;
        }, 3500);
    }
    getPayee() {
        this.fetch.getPayee().subscribe(res => { this.listPayee = res; }, err => { this.psMsg = { msg: err.error, alert: 'alert-danger' }; });
        setTimeout(() => {
            this.psMsg = null;
        }, 3500);
    }
    approvePay(spId, index) {
        this.fetch.apvSponsor(spId).subscribe(res => {
    ...
    delSpn(spId, index) {
        if (confirm("Are you sure want to delete?")) {
            this.fetch.delSponsor(spId).subscribe(res => {
    ...
    selectFile(event) {
        ...
        this.uploading = true;
        this.fetch.uploadImg(uFrm).subscribe((event) => {
    ...
    upBill() {
        ...
        if (this.billFrm.invalid) {
            ...
            this.fetch.uploadBill(formObj).subscribe(res => {
...
ProfilePgComponent.ctorParameters = () => [
...
ProfilePgComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-profile-pg',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./profile-pg.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/profile/profile-pg/profile-pg.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./profile-pg.component.scss */ "./src/app/profile/profile-pg/profile-pg.component.scss")).default]
    })
], ProfilePgComponent);
...
/* harmony import */ var _profile_pg_profile_pg_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./profile-pg/profile-pg.component */ "./src/app/profile/profile-pg/profile-pg.component.ts");
...
/* harmony import */ var _profile_pg_profile_pg_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./profile-pg/profile-pg.component */ "./src/app/profile/profile-pg/profile-pg.component.ts");
