...
let DealerDeliveryPgComponent = class DealerDeliveryPgComponent {
    constructor(formBuilder, fetch, modalService, filterSrv, deliveryService) {
        this.formBuilder = formBuilder;
        this.fetch = fetch;
        this.modalService = modalService;
        this.filterSrv = filterSrv;
        ...
        this.groupedData = [];
        this.productChange
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["debounceTime"])(900), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["distinctUntilChanged"])())
            .subscribe((value) => {
            console.log(value);
            this.productList = [];
            this.loadingProduct = true;
    ...
    openInvoiceStatus(template, billId) {
        this.updateStatusValue = "";
        console.log(this.billDData);
        const f = this.billDData.filter((data) => data._id == billId);
        console.log(f);
        if (f.length) {
