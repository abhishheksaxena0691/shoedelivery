        ...
        value: function logOn() {
          ...
          if (this.logFrm.invalid) {
            ...
            this.fetch.logUsr(formObj).subscribe(function (res) {
              ...
              _this.auth.sendToken(data.token, data.usrName, _this.logFrm.value.userType);
