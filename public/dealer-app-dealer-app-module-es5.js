      ...
      _createClass(DealerDashboadComponent, [{
        ...
        value: function getMonthData(sectionType) {
          ...
          this.deliveryService.getAllDelivery().subscribe(function (res) {
            ...
            console.log(_this25.paid);

            if (!_this25.paid) {
              setTimeout(function () {
                _this25.closeBtn.nativeElement.click();
              }, 2000);
            }
          }, function (err) {
            _this25.pgMsg = {
        ...
        value: function NewDealerBill() {
          ...
          this.fetch.createNewInvoice({
            ...
            res['domain'] = _this32.authService.getDomainName();
            res['companyName'] = _this32.authService.getCompanyName();
            setTimeout(function () {
              _this32.dMsg = {};
