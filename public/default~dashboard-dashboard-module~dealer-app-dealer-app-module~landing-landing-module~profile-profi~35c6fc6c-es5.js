...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~dashboard-dashboard-module~dealer-app-dealer-app-module~landing-landing-module~profile-profi~35c6fc6c"], {
  /***/
    ...
    var ComponentLoader = /*#__PURE__*/function () {
      ...
      _createClass(ComponentLoader, [{
        ...
        value: function listen(listenOpts) {
          ...
          */
          function () {
            return listenOpts.hide ? listenOpts.hide() : void _this41.hide();
          };
          /** @type {?} */
          ...
          */
          function (registerHide) {
            listenOpts.show ? listenOpts.show(registerHide) : _this41.show(registerHide);
            registerHide();
          };
          /** @type {?} */
          ...
          */
          function toggle(registerHide) {
            _this41.isShown ? hide() : show(registerHide);
          };
        ...
        value: function _registerOutsideClick() {
          ...
          if (this._listenOpts.outsideClick) {
            ...
            */
            function () {
              _this42._globalListener = Object(ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_1__["registerOutsideClick"])(_this42._renderer, {
                targets: [target, _this42._elementRef.nativeElement],
                outsideClick: _this42._listenOpts.outsideClick,
                hide:
                /**
                * @return {?}
                */
                function hide() {
                  return _this42._listenOpts.hide();
                }
              });
            });
          }
        ...
        value: function _subscribePositioning() {
          ...
          */
          function () {
            _this43._posService.position({
              element: _this43._componentRef.location,
              target: _this43._elementRef,
              attachment: _this43.attachment,
              appendToBody: _this43.container === 'body'
            });
          });
          ...
          */
          function () {
            if (!_this43._componentRef) {
              return;
            }

            _this43._posService.calcPosition();
          });
        }
        /**
         * @private
    ...
    var ModalContainerComponent = /*#__PURE__*/function () {
      ...
      _createClass(ModalContainerComponent, [{
        ...
        value: function ngOnInit() {
          ...
          */
          function () {
            _this44.isShown = true;

            _this44._renderer.addClass(_this44._element.nativeElement, Object(ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_1__["isBs3"])() ? CLASS_NAME.IN : CLASS_NAME.SHOW);
        ...
        value: function hide() {
          ...
          */
          function () {
            _this45.isShown = false;

            if (document && document.body && _this45.bsModalService.getModalsCount() === 1) {
              _this45._renderer.removeClass(document.body, CLASS_NAME.OPEN);
            }

            _this45.bsModalService.hide(_this45.level);

            _this45.isModalHiding = false;
        ...
        value: function showElement() {
          ...
          */
          function transitionComplete() {
            if (_this49._config.focus) {
              _this49._element.nativeElement.focus();
            }

            _this49.onShown.emit(_this49);
          };
        ...
        value: function hideModal() {
          ...
          */
          function () {
            if (!_this50.isNested) {
              if (ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_1__["document"] && ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_1__["document"].body) {
                _this50._renderer.removeClass(ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_1__["document"].body, CLASS_NAME.OPEN);
              }

              _this50.resetScrollbar();
            }

            _this50.resetAdjustments();

            _this50.focusOtherModal();

            _this50.onHidden.emit(_this50);
          });
    ...
    var BsModalService = /*#__PURE__*/function () {
      ...
      _createClass(BsModalService, [{
        ...
        value: function hide(level) {
          ...
          */
          function () {
            _this52._hideModal(level);

            _this52.removeLoaders(level);
        ...
        value: function _showModal(content) {
          ...
          if (this.config && this.config.providers) {
            var _iterator2 = _createForOfIteratorHelper(this.config.providers),
                _step2;
          ...
          */
          function () {
            /** @type {?} */
            var duration = _this54.config.animated ? TRANSITION_DURATIONS.MODAL : 0;
            setTimeout(
            /**
            * @return {?}
            */
        ...
        value: function copyEvent(from, to) {
          ...
          */
          function () {
            to.emit(_this55.lastDismissReason);
          });
        }
      }]);
    ...
    var PositioningService = /*#__PURE__*/function () {
      ...
      function PositioningService(ngZone, rendererFactory, platformId) {
        ...
        if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["isPlatformBrowser"])(platformId)) {
          ...
          */
          function () {
            _this56.triggerEvent$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(window, 'scroll', {
              passive: true
            }), Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(window, 'resize', {
              passive: true
            }),
            /* tslint:disable-next-line: deprecation */
            Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(0, rxjs__WEBPACK_IMPORTED_MODULE_2__["animationFrameScheduler"]), _this56.update$$);

            _this56.triggerEvent$.subscribe(
            /**
            * @return {?}
            */
            function () {
              if (_this56.isDisabled) {
                return;
              }

              _this56.positionElements
              /* tslint:disable-next-line: no-any */
              .forEach(
              /**
              ...
              */
              function (positionElement) {
                positionElements(_getHtmlElement(positionElement.target), _getHtmlElement(positionElement.element), positionElement.attachment, positionElement.appendToBody, _this56.options, rendererFactory.createRenderer(null, null));
              });
            });
          });
        }
...
//# sourceMappingURL=default~dashboard-dashboard-module~dealer-app-dealer-app-module~landing-landing-module~profile-profi~35c6fc6c-es5.js.map