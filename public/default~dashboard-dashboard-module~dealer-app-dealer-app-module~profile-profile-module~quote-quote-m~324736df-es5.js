...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~dashboard-dashboard-module~dealer-app-dealer-app-module~profile-profile-module~quote-quote-m~324736df"], {
  /***/
    ...
    var ComponentLoader = /*#__PURE__*/function () {
      ...
      _createClass(ComponentLoader, [{
        ...
        value: function listen(listenOpts) {
          ...
          */
          function () {
            return listenOpts.hide ? listenOpts.hide() : void _this2.hide();
          };
          /** @type {?} */
          ...
          */
          function (registerHide) {
            listenOpts.show ? listenOpts.show(registerHide) : _this2.show(registerHide);
            registerHide();
          };
          /** @type {?} */
          ...
          */
          function toggle(registerHide) {
            _this2.isShown ? hide() : show(registerHide);
          };
        ...
        value: function _registerOutsideClick() {
          ...
          if (this._listenOpts.outsideClick) {
            ...
            */
            function () {
              _this3._globalListener = Object(ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_1__["registerOutsideClick"])(_this3._renderer, {
                targets: [target, _this3._elementRef.nativeElement],
                outsideClick: _this3._listenOpts.outsideClick,
                hide:
                /**
                * @return {?}
                */
                function hide() {
                  return _this3._listenOpts.hide();
                }
              });
            });
          }
        ...
        value: function _subscribePositioning() {
          ...
          */
          function () {
            _this4._posService.position({
              element: _this4._componentRef.location,
              target: _this4._elementRef,
              attachment: _this4.attachment,
              appendToBody: _this4.container === 'body'
            });
          });
          ...
          */
          function () {
            if (!_this4._componentRef) {
              return;
            }

            _this4._posService.calcPosition();
          });
        }
        /**
         * @private
        ...
        value: function ngOnInit() {
          ...
          */
          function () {
            ...
            _this5._renderer.addClass(_this5._element.nativeElement, Object(ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_1__["isBs3"])() ? CLASS_NAME.IN : CLASS_NAME.SHOW);
        ...
        value: function hide() {
          ...
          */
          function () {
            ...
            if (document && document.body && _this6.bsModalService.getModalsCount() === 1) {
              _this6._renderer.removeClass(document.body, CLASS_NAME.OPEN);
            }

            _this6.bsModalService.hide(_this6.level);

            _this6.isModalHiding = false;
          ...
          */
          function transitionComplete() {
            if (_this10._config.focus) {
              _this10._element.nativeElement.focus();
            }

            _this10.onShown.emit(_this10);
          };
        ...
        value: function hideModal() {
          ...
          */
          function () {
            if (!_this11.isNested) {
              if (ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_1__["document"] && ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_1__["document"].body) {
                _this11._renderer.removeClass(ngx_bootstrap_utils__WEBPACK_IMPORTED_MODULE_1__["document"].body, CLASS_NAME.OPEN);
              }

              _this11.resetScrollbar();
            }

            _this11.resetAdjustments();

            _this11.focusOtherModal();

            _this11.onHidden.emit(_this11);
          });
    ...
    var BsModalService = /*#__PURE__*/function () {
      ...
      _createClass(BsModalService, [{
        ...
        value: function hide(level) {
          ...
          */
          function () {
            _this13._hideModal(level);

            _this13.removeLoaders(level);
        ...
        value: function _showModal(content) {
          ...
          */
          function () {
            /** @type {?} */
            var duration = _this15.config.animated ? TRANSITION_DURATIONS.MODAL : 0;
            setTimeout(
            /**
            * @return {?}
            */
        ...
        value: function copyEvent(from, to) {
          ...
          */
          function () {
            to.emit(_this16.lastDismissReason);
          });
        }
      }]);
    ...
    var PositioningService = /*#__PURE__*/function () {
      ...
      function PositioningService(ngZone, rendererFactory, platformId) {
        ...
        if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_1__["isPlatformBrowser"])(platformId)) {
          ...
          */
          function () {
            _this17.triggerEvent$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(window, 'scroll', {
              passive: true
            }), Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(window, 'resize', {
              passive: true
            }),
            /* tslint:disable-next-line: deprecation */
            Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(0, rxjs__WEBPACK_IMPORTED_MODULE_2__["animationFrameScheduler"]), _this17.update$$);

            _this17.triggerEvent$.subscribe(
            /**
            * @return {?}
            */
            function () {
              if (_this17.isDisabled) {
                return;
              }

              _this17.positionElements
              /* tslint:disable-next-line: no-any */
              .forEach(
              /**
              ...
              */
              function (positionElement) {
                positionElements(_getHtmlElement(positionElement.target), _getHtmlElement(positionElement.element), positionElement.attachment, positionElement.appendToBody, _this17.options, rendererFactory.createRenderer(null, null));
              });
            });
          });
        }
...
//# sourceMappingURL=default~dashboard-dashboard-module~dealer-app-dealer-app-module~profile-profile-module~quote-quote-m~324736df-es5.js.map