...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["shoping-shoping-module"], {
  ...
  function srcAppShopingAddproductAddproductComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "\n@import url(\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css\");\n@charset \"UTF-8\";\n.custom-file-upload {\n  border: 1px solid #ccc;\n  display: inline-block;\n  padding: 6px 12px;\n  cursor: pointer;\n}\ninput[type=file] {\n  display: none;\n}\n.setColor {\n  background-color: #AA0000 !important;\n  color: #ffffff;\n}\n.container1 {\n  width: 300px;\n  height: auto;\n  margin: 30px auto;\n}\n.card {\n  border-radius: 25px;\n  box-shadow: -11px 11px 1px rgba(255, 253, 253, 0.3);\n}\n.card-head {\n  height: 200px;\n  border-radius: 25px 25px 0 0;\n}\n.product-img {\n  left: 0;\n}\n.product-detail {\n  padding: 0 20px;\n  font-size: 11px;\n  color: #fff;\n}\n.product-detail h2 {\n  font-size: 18px;\n  font-weight: 500;\n  letter-spacing: 2px;\n  padding-bottom: 10px;\n  text-transform: capitalize;\n}\n.back-text {\n  display: inline-block;\n  font-size: 125px;\n  font-weight: 900;\n  margin-left: -7px;\n  margin-top: -12px;\n  opacity: 0.1;\n}\n.card-body {\n  min-height: 330px;\n  height: auto;\n  background: #fff;\n  border-radius: 0 0 25px 25px;\n}\n.product-title {\n  padding: 20px 20px 5px 20px;\n  display: block;\n  font-size: 17px;\n  font-weight: 500;\n  letter-spacing: 1px;\n  text-transform: capitalize;\n}\n.product-title b {\n  font-weight: 900;\n  letter-spacing: 0px;\n}\n.badge {\n  position: relative;\n  font-size: 14px;\n  font-weight: 300;\n  color: #fff;\n  background: #dc3545;\n  padding: 15px 10px;\n  border-radius: 50%;\n  top: -2px;\n  margin-left: 5px;\n  float: right;\n}\n.product-caption {\n  display: block;\n  padding: 0 20px;\n  font-size: 15px;\n  font-weight: 400;\n  text-transform: capitalize;\n}\n.product-rating {\n  float: left;\n  padding-left: 1rem;\n}\n.product-rating i.grey {\n  color: #cece15;\n}\n.product-size h4 {\n  font-size: 15px;\n  padding: 0 21px;\n  margin-top: 15px;\n  padding-bottom: 10px;\n  text-transform: uppercase;\n}\n.ul-size {\n  margin-left: 15px;\n}\n.ul-size li {\n  list-style: none;\n  float: left;\n  margin-right: 20px;\n}\n.ul-size li a {\n  display: block;\n  text-decoration: none;\n  font-size: 11px;\n  width: 22px;\n  height: 22px;\n  border-radius: 100%;\n  text-align: center;\n  line-height: 23px;\n  color: #000;\n}\n.ul-size li a.active {\n  background: #f35e3d;\n  color: #fff;\n}\n.product-size:before,\n.product-size:after {\n  content: \"\";\n  display: block;\n  clear: both;\n}\n.product-color h4 {\n  font-size: 11px;\n  padding: 0 21px;\n  margin-top: 20px;\n  padding-bottom: 20px;\n  text-transform: uppercase;\n}\n.ul-color {\n  margin-left: 27px;\n}\n.ul-color li {\n  list-style: none;\n  float: left;\n  margin-right: 20px;\n}\n.ul-color li a {\n  display: inline-block;\n  width: 16px;\n  height: 16px;\n  border-radius: 100%;\n}\n.ul-color li a.orange {\n  background: #f35e3d;\n}\n.ul-color li a.green {\n  background: #dc3545;\n}\n.ul-color li a.yellow {\n  background: #ffd414;\n}\n.ul-color li a.active:after {\n  position: absolute;\n  content: \"\";\n  display: inline-block;\n  border: 1px solid #f35e3d;\n  width: 24px;\n  height: 24px;\n  border-radius: 100%;\n  margin-left: -5px;\n  margin-top: -5px;\n}\n.product-price {\n  background: #dc3545;\n  padding: 7px 20px;\n  text-align: center;\n  display: inline-block;\n  font-size: 15px;\n  font-weight: 200;\n  color: #fff;\n  border-radius: 7px;\n  margin-top: -13px;\n  margin-left: -5px;\n  box-shadow: -10px 20px 15px -10px rgba(17, 233, 91, 0.3);\n}\n.product-price b {\n  margin-left: 5px;\n}\n.yt {\n  position: fixed;\n  padding: 7px 10px 3px 10px;\n  top: 5px;\n  right: 5px;\n  background: rgba(0, 0, 0, 0.1);\n}\n.yt:hover {\n  background: rgba(0, 0, 0, 0.2);\n}\n.Plusbutton {\n  background-color: #dc3545;\n  border: none;\n  color: white;\n  text-align: center;\n  text-decoration: none;\n  display: inline-block;\n  font-size: 12px;\n  margin: 4px 2px;\n  width: 20px;\n  height: 20px;\n}\n.button5 {\n  border-radius: 50%;\n}\n.input-number {\n  width: 50% !important;\n  flex: 1 1 0%;\n}\n.checked {\n  color: orange;\n}\n.fa-star {\n  cursor: pointer;\n  font-size: 21px;\n}\n/***************** Detail Page *************************/\n.preview {\n  display: flex;\n  flex-direction: column;\n}\n@media screen and (max-width: 996px) {\n  .preview {\n    margin-bottom: 20px;\n  }\n}\n.preview-pic {\n  flex-grow: 1;\n}\n.preview-thumbnail.nav-tabs {\n  border: none;\n  margin-top: 15px;\n}\n.preview-thumbnail.nav-tabs li {\n  width: 18%;\n  margin-right: 2.5%;\n}\n.preview-thumbnail.nav-tabs li img {\n  max-width: 100%;\n  display: block;\n  height: 177px !important;\n}\n.preview-thumbnail.nav-tabs li a {\n  padding: 0;\n  margin: 0;\n}\n.preview-thumbnail.nav-tabs li:last-of-type {\n  margin-right: 0;\n}\n.tab-content {\n  overflow: hidden;\n}\n.tab-content img {\n  width: 100%;\n  -webkit-animation-name: opacity;\n  animation-name: opacity;\n  -webkit-animation-duration: 0.3s;\n  animation-duration: 0.3s;\n}\n.cardDetails {\n  margin-top: 50px;\n  background: #eee;\n  padding: 3em;\n  line-height: 1.5em;\n}\n@media screen and (min-width: 997px) {\n  .wrapper {\n    display: flex;\n  }\n}\n.details {\n  display: flex;\n  flex-direction: column;\n}\n.colors {\n  flex-grow: 1;\n}\n.product-title, .price, .sizes, .colors {\n  text-transform: capitalize;\n  font-weight: bold;\n}\n.checked, .price span {\n  color: #ff9f1a;\n}\n.product-title {\n  margin-top: 0;\n}\n.size {\n  margin-right: 10px;\n}\n.size:first-of-type {\n  margin-left: 40px;\n}\n.color {\n  display: inline-block;\n  vertical-align: middle;\n  margin-right: 10px;\n  height: 2em;\n  width: 2em;\n  border-radius: 2px;\n}\n.color:first-of-type {\n  margin-left: 20px;\n}\n.add-to-cart, .like {\n  background: #ff9f1a;\n  padding: 0.5em 1em;\n  border: none;\n  text-transform: UPPERCASE;\n  font-weight: bold;\n  color: #fff;\n  transition: background 0.3s ease;\n}\n.add-to-cart:hover, .like:hover {\n  background: #b36800;\n  color: #fff;\n}\n.not-available {\n  text-align: center;\n  line-height: 2em;\n}\n.not-available:before {\n  font-family: fontawesome;\n  content: \"\";\n  color: #fff;\n}\n.orange {\n  background: #ff9f1a;\n}\n.green {\n  background: #85ad00;\n}\n.blue {\n  background: #0076ad;\n}\n.tooltip-inner {\n  padding: 1.3em;\n}\n@-webkit-keyframes opacity {\n  0% {\n    opacity: 0;\n    transform: scale(3);\n  }\n  100% {\n    opacity: 1;\n    transform: scale(1);\n  }\n}\n@keyframes opacity {\n  0% {\n    opacity: 0;\n    transform: scale(3);\n  }\n  100% {\n    opacity: 1;\n    transform: scale(1);\n  }\n}\n/*# sourceMappingURL=style.css.map */\n.star {\n  font-size: 12px;\n}\n.detailStar {\n  font-size: 15px;\n}\n.btn {\n  cursor: pointer;\n}\n.sm-text {\n  font-size: 10px;\n  letter-spacing: 1px;\n}\n.sm-text-1 {\n  font-size: 14px;\n}\n.green-tab {\n  background-color: #00C853;\n  color: #fff;\n  border-radius: 5px;\n  padding: 5px 3px 5px 3px;\n}\n.btn-red {\n  background-color: #E64A19;\n  color: #fff;\n  border-radius: 20px;\n  border: none;\n  outline: none;\n}\n.btn-red:hover {\n  background-color: #BF360C;\n}\n.btn-red:focus {\n  box-shadow: none !important;\n  outline-width: 0;\n}\n.round-icon {\n  font-size: 40px;\n  padding-bottom: 10px;\n}\n.fa-circle {\n  font-size: 10px;\n  color: #EEEEEF;\n}\n.green-dot {\n  color: #4CAF50;\n}\n.red-dot {\n  color: #E64A19;\n}\n.yellow-dot {\n  color: #FFD54F;\n}\n.grey-text {\n  color: #BDBDBD;\n}\n.green-text {\n  color: #4CAF50;\n}\n.block {\n  border-right: 1px solid #F5EEEE;\n  border-top: 1px solid #F5EEEE;\n  border-bottom: 1px solid #F5EEEE;\n}\n.profile-pic {\n  border-radius: 50%;\n  height: 40px;\n  width: 40px;\n  padding: 5px;\n  border: 1px solid #000;\n}\n.rating-dot {\n  letter-spacing: 5px;\n}\n.via {\n  border-radius: 20px;\n  height: 28px;\n}\n/* Base styling*/\n.popover__title {\n  font-size: 10px;\n  text-decoration: none;\n  color: #e44444;\n  text-align: center;\n}\n.popover__wrapper {\n  position: relative;\n  display: inline-block;\n}\n.popover__content {\n  opacity: 0;\n  visibility: hidden;\n  position: absolute;\n  width: 200px;\n  left: -100px;\n  transform: translate(0, 10px);\n  background-color: #fff;\n  padding: 0.5rem;\n  box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.26);\n  width: auto;\n}\n.popover__wrapper:hover .popover__content {\n  z-index: 10;\n  opacity: 1;\n  visibility: visible;\n  transform: translate(0, -20px);\n  transition: all 0.5s cubic-bezier(0.75, -0.02, 0.2, 0.97);\n}\n.popover__message {\n  text-align: center;\n  font-size: 10px;\n}\n.cardDiv {\n  height: 20px;\n  word-break: break-all;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.cardmerchant {\n  box-shadow: 0 4px 8px 0;\n  max-width: 300px;\n  margin: auto;\n  text-align: center;\n  font-family: arial;\n  border-radius: 25px;\n  background-color: #fff;\n}\n.cardmerchant h1 {\n  padding-left: 3rem;\n}\n.pricemercahnt {\n  color: grey;\n  font-size: 22px;\n}\n.merchantName {\n  font-size: 22px;\n  text-transform: capitalize;\n}\n.cardmerchant button {\n  border: none;\n  outline: 0;\n  padding: 12px;\n  color: white;\n  background-color: #AA0000;\n  text-align: center;\n  cursor: pointer;\n  width: 100%;\n  font-size: 18px;\n}\n.cardmerchant button:hover {\n  opacity: 0.7;\n}\n.rowSegregate {\n  border-bottom: 2px solid #ccc;\n}\n.star-rating {\n  display: flex;\n  align-items: center;\n  font-size: 3em;\n  justify-content: center;\n  margin-top: 10px;\n}\n.back-stars {\n  display: flex;\n  color: #ccc;\n  position: relative;\n  text-shadow: 4px 4px 10px #843a3a;\n}\n.front-stars {\n  display: flex;\n  color: #AA0000;\n  overflow: hidden;\n  position: absolute;\n  text-shadow: 1px 1px 1px #AA0000;\n  top: 0;\n  transition: all 0.5s;\n}\n.progress-bar {\n  background-color: #AA0000 !important;\n}\n.topnav {\n  overflow: hidden;\n  float: left;\n}\n.topnav a {\n  float: left;\n  display: block;\n  text-align: center;\n  text-decoration: none;\n  border-bottom: 1px solid #ccc;\n  text-transform: uppercase;\n  font-size: 14px;\n  font-weight: 600;\n  color: #AA0000;\n  opacity: 1;\n}\n.topnav a:hover {\n  border-bottom: 3px solid #AA0000;\n  cursor: pointer;\n}\n.topnav a.active {\n  border-bottom: 3px solid #AA0000;\n}\n.topnav a {\n  padding: 0.05rem 2.9rem;\n}\n.discountFeild {\n  width: 30%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(AddproductComponent, [{
        ...
        value: function selectCategory(val) {
          ...
          if (val == 'category1') {
            this.objArray = [{
              "name": "TV",
              "value": "subCategorytype11"
            }, {
              "name": "Camera",
              "value": "subCategorytype12"
            }, {
              "name": "Mobile",
              "value": "subCategorytype13"
            }, {
              "name": "Tablet",
              "value": "subCategorytype14"
            }, {
              "name": "Laptop",
              "value": "subCategorytype15"
            }, {
              "name": "Genral",
              "value": "subCategorytype16"
            }];
          }
          ...
          if (val == 'category2') {
            this.objArray = [{
              "name": "Sofa",
              "value": "subCategorytype21"
            }, {
              "name": "Table",
              "value": "subCategorytype22"
            }, {
              "name": "Chair",
              "value": "subCategorytype23"
            }, {
              "name": "Mattresses",
              "value": "subCategorytype24"
            }, {
              "name": "Cot",
              "value": "subCategorytype25"
            }, {
              "name": "Stand",
              "value": "subCategorytype26"
            }, {
              "name": "General",
              "value": "subCategorytype27"
            }];
          }
          ...
          if (val == 'category3') {
            this.objArray = [{
              "name": "4 Wheeler",
              "value": "subCategorytype31"
            }, {
              "name": "2 Wheeler",
              "value": "subCategorytype32"
            }, {
              "name": "Cycle",
              "value": "subCategorytype33"
            }, {
              "name": "Spare part",
              "value": "subCategorytype34"
            }, {
              "name": "General",
              "value": "subCategorytype35"
            }];
          }
          ...
          if (val == 'category4') {
            this.objArray = [{
              ...
              "value": "subCategorytype41"
            }, {
              "name": "AC",
              "value": "subCategorytype42"
            }, {
              "name": " Air cooler",
              "value": "subCategorytype43"
            }, {
              "name": "MicroWave",
              "value": "subCategorytype44"
            }, {
              "name": "Geyser",
              "value": "subCategorytype45"
            }, {
              "name": "General",
              "value": "subCategorytype46"
            }];
          }
          ...
          if (val == 'category6') {
            this.objArray = [{
              "name": "Mens",
              "value": "subCategorytype61"
            }, {
              "name": "Women",
              "value": "subCategorytype62"
            }, {
              "name": "Boys",
              "value": "subCategorytype63"
            }, {
              "name": "Girls",
              "value": "subCategorytype64"
            }];
          }
          ...
          if (val == 'category7') {
            this.objArray = [{
              "name": "Story",
              "value": "subCategorytype71"
            }, {
              "name": "Novel",
              "value": "subCategorytype72"
            }, {
              "name": "Science",
              "value": "subCategorytype73"
            }, {
              "name": "School",
              "value": "subCategorytype74"
            }, {
              "name": "Book",
              "value": "subCategorytype75"
            }, {
              "name": "Ecconomics",
              "value": "subCategorytype76"
            }, {
              "name": "Genral",
              "value": "subCategorytype77"
            }];
          }
          ...
          if (val == 'category8') {
            this.objArray = [{
              "name": "Cricket",
              "value": "subCategorytype81"
            }, {
              "name": "Tennies",
              "value": "subCategorytype82"
            }, {
              "name": "Long Tennies",
              "value": "subCategorytype83"
            }, {
              "name": "General",
              "value": "subCategorytype84"
            }];
          }
        ...
        value: function addProduct(template) {
          ...
          if (this.editProductStatus) {
            var _msg = "Product edit successfully.";
            url = "product/editProduct";
          }

          this.fetch.addProduct(data, url).subscribe(function () {
        ...
        value: function editProduct(data) {
          ...
          this.classifiedForm.patchValue({
            ...
            "keyFeatureOne": data.keyFeatureOne,
            "keyFeatureTwo": data.keyFeatureTwo,
            "keyFeatureThree": data.keyFeatureThree,
            "brand": data.brand,
            "showNumber": data.showNumber
          });
          this.fileNames = data.fileName;
          var index = data.fileName.findIndex(function (data) {
            return data.extension == 'mp4';
          });
          this.imgURL = data.fileName.filter(function (data) {
            return data.extension != 'mp4';
          });
          console.log(this.editfileNames);

          if (index > -1) {
            this.uploadedVideo = data.fileName[index].name;
          }
        ...
        value: function myorders() {
          ...
          this.fetch.myorder().subscribe(function (data) {
            ...
            console.log(_this8.allOrderList);
            _this8.orderList = _this8.allOrderList.filter(function (d) {
              return d.status == 'open' || d.status == 'acceptedByMerchant';
            });
          });
        } // updateStatus (type, id, index) {
        //   const data = {"id": id, "value":{status: type ? 'acceptByMerchant' : 'rejectByMerchant' }};
        //   this.fetch.acceptedInvoice(data).subscribe((data: any) => {
        //     this.orderList[index].status = type ? 'acceptByMerchant' : 'rejectByMerchant';
        //   });
        // }

      }, {
        key: "updateStatus",
        value: function updateStatus(id, type, index) {
          var _this9 = this;
          ...
          if (type == 'acceptedByMerchant') {
            data = {
              ...
              "value": {
                status: type,
                list: this.orderList[index].list,
                "totalamount": this.orderList[index].totalamount
              }
            };
          }

          this.fetch.acceptedInvoice(data).subscribe(function (data) {
            _this9.orderList[index].status = type;
            sweetalert2_dist_sweetalert2_all_min_js__WEBPACK_IMPORTED_MODULE_9___default.a.fire({
        ...
        value: function changeTab(type, val) {
          ...
          if (val == 'open') {
            this.orderList = this.allOrderList.filter(function (d) {
              return d.status == 'acceptedByMerchant' || d.status == 'open';
            });
          } else {
            this.orderList = this.allOrderList.filter(function (d) {
              return d.status == val;
        ...
        key: "InvoiceSend",
        value: function InvoiceSend(data, type, index) {
          var _this10 = this;
          ...
          this.fetch.InvoiceSend(requestData).subscribe(function () {
            _this10.orderList[index].status = type;
            sweetalert2_dist_sweetalert2_all_min_js__WEBPACK_IMPORTED_MODULE_9___default.a.fire({
              title: "Updated successfully.",
              text: "",
              icon: 'success',
            ...
            _this10.dasboard.createNewInvoice({
              "selectedProducts": selectedProduct,
              "company": _this10.profInfo.companyName,
              "type": "shop",
              "totalamount": data.totalamount - data.discount
            }).subscribe(function (res) {
              res["mobilenumber"] = data.senderNumber;
              res['domain'] = _this10.profInfo.domain;
              res['companyName'] = _this10.profInfo.companyName;
              res['type'] = 'shop';
              setTimeout(function () {
                _this10.deliveryService.generateImageNewInvoice(res).subscribe(function () {});
              }, 2800);
            }, function (err) {});
          });
        }
        ...
        key: "applyDiscount",
        value: function applyDiscount(id, index) {
          var _this11 = this;

          if (this.orderList[index].totalamount > this.discount && parseInt(this.discount) > 0) {
            this.fetch.updateDiscount({
              ...
              //this.orderList[index].totalamount = parseInt(this.orderList[index].totalamount) - parseInt(this.discount);
              _this11.orderList[index]['discount'] = _this11.discount;
            });
          } else {
            sweetalert2_dist_sweetalert2_all_min_js__WEBPACK_IMPORTED_MODULE_9___default.a.fire({
        ...
        value: function updateValue(index, value) {
          //this.orderList[index].totalamount = this.orderList[index].totalamount - parseInt(value);
          this.discount = parseInt(value);
        }
      }, {
        key: "removeProduct",
        value: function removeProduct(index, key, type) {
          var _this12 = this;

          if (type) {
            delete this.orderList[index].list[key];
          } else {
            this.orderList[index].list[key] = this.orderList[index].productList.filter(function (data) {
              return data.name == key;
            })[0].price;
          }

          this.orderList[index].totalamount = 0;
          Object.keys(this.orderList[index].list).forEach(function (key, value) {
            return _this12.orderList[index].totalamount += _this12.orderList[index].list[key];
          });
          console.log(this.orderList[index].discount);
        }
      }]);
